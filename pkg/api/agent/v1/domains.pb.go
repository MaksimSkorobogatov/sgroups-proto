...
const file_agent_v1_domains_proto_rawDesc = "" +
	...
	"\x02fd\x18\x05 \x01(\x05R\x02fd\"\xfe\x05\n" +
	"\bSockStat\x12\x1a\n" +
	...
	"\tprocesses\x18\n" +
	" \x03(\v2\x15.agent.v1.ProcessInfoR\tprocesses\x1a\x99\x03\n" +
	"\tSelectors\x12\x1a\n" +
	"\bprotocol\x18\x01 \x01(\tR\bprotocol\x12,\n" +
	"\x06family\x18\x02 \x01(\x0e2\x14.common.IpAddrFamilyR\x06family\x12)\n" +
	"\x05state\x18\x03 \x01(\x0e2\x13.agent.v1.ConnStateR\x05state\x12\x1d\n" +
	...
	"\n" +
	"local_port\x18\x05 \x01(\x05H\x00R\tlocalPort\x88\x01\x01\x12\x1f\n" +
	"\vremote_addr\x18\x06 \x01(\tR\n" +
	"remoteAddr\x12$\n" +
	"\vremote_port\x18\a \x01(\x05H\x01R\n" +
	"remotePort\x88\x01\x01\x12\x16\n" +
	"\x06ifname\x18\b \x01(\tR\x06ifname\x12\x19\n" +
	"\x05inode\x18\t \x01(\x03H\x02R\x05inode\x88\x01\x01\x12\x15\n" +
	"\x03pid\x18\n" +
	" \x01(\x05H\x03R\x03pid\x88\x01\x01\x12\x12\n" +
	"\x04comm\x18\v \x01(\tR\x04commB\r\n" +
	"\v_local_portB\x0e\n" +
	"\f_remote_portB\b\n" +
	"\x06_inodeB\x06\n" +
	"\x04_pid\"2\n" +
...
func file_agent_v1_domains_proto_init() {
	...
	file_agent_v1_domains_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
